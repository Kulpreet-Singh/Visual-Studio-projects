/*
Q1. Design a Minimized DFA for the Regular Expression (a/b)*abb i.e. All strings ending with abb. This will involve three steps:
i.	    Generate the NFA using Thomson’ s Construction (3 Marks) (2 Lab of 2 Hrs.)
ii. 	Generate the DFA using Subset Construction (5 marks) (3 Labs of 2 Hrs. each)
iii. 	Minimize the DFA generated (2 Marks)(2 Labs of 2 Hrs. each)
iv. 	Input will be any RE and output should be ‘Accept’ if RE end in ‘abb’ and it should be ‘Not Accepted’ if RE does not end in ‘abb’
*/
#include<iostream>
#include<vector>
#include<string>
...
void print_menu() {
    ...
    cout << "4. Enter string to check if it ends with abb or not\n";
...
void simulate(int start_st, vector<tuple<int, int, bool> >min_dfa) {
    print_menu();
    cout << "Enter string (allowed language {a,b}): ";
    string input;
    cin.ignore();
    getline(cin, input);
